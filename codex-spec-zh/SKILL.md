...
如果用户只说“执行下一步”，先读取 `ACTIVE_TASK` 与当前任务目录，再基于 `执行计划.md`（兼容旧 `plan.md`）选择下一个未完成步骤。
...
优先使用中文输出；新任务默认使用中文目录与中文文档名，旧任务兼容 `spec.md / plan.md / progress.md / acceptance.md`。
